...
@section('page-script')
    <script src="{{ asset('assets/js/modal-testimonials.js') }}"></script>
...
@section('content')
    ...
    <div class="card py-3 my-3">
        <div class="container">
            <table id="dataTableTestimonial" class="table table-striped table-hover dt-responsive">
                ...
                <tbody>
                    <tr>
                        <td>
                            <h6 class="shrt-frm m-0">LiveWire.Inc </h6>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        <div class="offcanvas-header border-bottom">
            <h5 id="offcanvasEndLabel" class="offcanvas-title">Add Testimonials</h5>
        ...
        <div class="offcanvas-body">
            <form id="editUserForm" class="row g-3" onsubmit="return false">
                ...
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInput" placeholder="Enter E-mail ID">
                ...
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInput" placeholder="Enter rank">
