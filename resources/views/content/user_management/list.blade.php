                ...
                <div class="dropFilter packages">
                    <div class="title-filter">
                        <select id="" name="countryFilter" class="countryFilter form-select">
                            <option value="" selected>Company Country of residance</option>
                    ...
                    <div class="">
                        <select name="sectorFilter" id="sectorFilter" class="form-select sectorFilter">
                            <option value="" selected>Sectors of activities</option>
                            <option value="Computer">Computer</option>
                            <option value="Mining Industry">Mining Industry</option>
                            <option value="IA Technology">IA Technology</option>
                        </select>
                    </div>
                    <div class="">
            ...
            <table class="table table-striped table-hover dt-responsive" id="dataTable">
                ...
                <thead class="bg-primary">
                    <tr>
                        ...
                        <th scope="col">Sectors of activities</th>
                            ...
                            <div class="d-flex justify-content-start align-items-center user-name">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('user-view-account') }}" class="text-body text-truncate">
                                        ...
                                        class="text-danger">zmcclevertye@soundcloud.com</small><span
