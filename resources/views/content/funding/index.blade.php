...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/funding.js') }}"></script>
...
@section('content')
            ...
            <div class="filterable">
                <div class="dropFilter packages">
                    <div class="title-filter">
                        <select id="" name="sourceFilter" class="sourceFilter form-select">
                            <option value="" selected>Funding Source</option>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCTDTypes"
        aria-labelledby="offcanvasAddCTDTypesLabel">
        <div class="offcanvas-header border-bottom">
            <h6 id="offcanvasAddUserLabel" class="offcanvas-title">Add CTD Type</h6>
        ...
        <div class="offcanvas-body mx-0 pt-0 flex-grow-0">
                ...
                <div class="col-md p-4">
                    <div class="form-check form-check-inline mt-3">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1"
                            value="option1" onclick="show1();" @checked(true)>
                        <label class="form-check-label" for="inlineRadio1">National Funding</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2"
                            value="option2" onclick="show2();">
                        <label class="form-check-label" for="inlineRadio2">International Funding</label>
                    </div>
                </div>
            </form>
            <form id="national" class="add-new-pack pt-0">
                <h3 @class(['text-center', 'h5', 'font-bold' => true])>National Funding</h3>
                <div class="my-3">
                                ...
                                <div class="row">
                                    <div class="col-9 nopadding">
                                        <div class="form-group">
                                            <label for="NatFdr">National Founder name *</label>
                                            <input type="text" class="form-control" id="NatFdr"
                                                name="Schoolname[]" value="" placeholder="Founder name">
                                        </div>
                                    </div>
            ...
            <form id="international" class="add-new-pack pt-0" style="display: none">
                <div class="my-3">
                    <h3 @class(['text-center', 'h5', 'font-bold' => true])>International Funding</h3>
                    <div class="form-floating">
                        <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                            <option value="en" selected>English</option>
                            <option value="ar">Arabic</option>
                        ...
                        <div class="my-3">
                            <div class="container-fluid p-0">
                                <div class="row">
                                    ...
                                    <div class="col-9 nopadding">
                                        <div class="form-group">
                                            <label for="IntFdr">International Founder name *</label>
                                            <input type="text" class="form-control" id="IntFdr"
                                                name="Schoolname[]" value="" placeholder="Funding name">
                                        </div>
                                    </div>
                                    <div class="col-3 nopadding">
                                        <div class="input-group-btn d-flex justify-content-end">
