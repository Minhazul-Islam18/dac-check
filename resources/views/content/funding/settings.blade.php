  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      ...
      <form class="add-new-user pt-0 consult" id="addConsult" style="display: none">
        ...
        <div class="mb-3">
            <label class="form-label" for="Commission of DAC-Rapide">Commission of DAC-Rapide [1000-5000] F FCA</label>
            <input class="form-control" type="number" value="2000" id="html5-number-input">         
        </div>
        <div class="mb-3">
            <label class="form-label" for="Commission of DAC-Rapide">Commission for PO [.01-.99]</label>
            <input class="form-control" type="number" value=".01" id="html5-number-input">
      ...
      <form class="add-new-user pt-0 postulate" id="addPostulate" style="display: block">
        ...
        <div class="mb-3">
            <label class="form-label" for="Commission of DAC-Rapide">Commission of DAC-Rapide [0.1-0.99]</label>
