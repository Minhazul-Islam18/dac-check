                    ...
                    <div class="row">
                        <div class="col-9">
                            <nav aria-label="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Call to acion</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-md-12 ps-3 mb-3 p-0">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="file" 
                                    ...
                                    data-max-files="3" />
                                    <span style="color: #e85903;font-weight: 600;">* JPG, PNG, JPEG, SVG images are allowed.</span>
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="Enter Sub-title" required>
