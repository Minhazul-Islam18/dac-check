    ...
    <div class="row gy-4">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/user/view/statistics') }}"><i class='bx bx-stats'></i>Expenses statistics</a></li>
            </ul>
            <hr>
            <!-- Project table -->
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-nowrap">
                                    <h6 class="fw-bold mb-1">Document Purchased</h6>
                                    <small>Be notified every time you purchased a document.</small>
                                </td>
                                <td>
                                    <div class="form-check d-flex justify-content-center">
                                        <input class="form-check-input" type="checkbox" id="defaultCheck7" checked />
                            ...
                            <tr>
                                <td class="text-nowrap">
                                    <h6 class="fw-bold mb-1">Download Completed</h6>
                                    <small>Be notified when you completed a download.</small>
                                </td>
                                <td>
                                    <div class="form-check d-flex justify-content-center">
                                        <input class="form-check-input" type="checkbox" id="defaultCheck10" checked />
                            ...
                            <tr>
                                <td class="text-nowrap">
                                    <h6 class="fw-bold mb-1">Wallet transfer</h6>
                                    <small>Be notified when you transfer your wallet to someone else.</small>
                                </td>
                                <td>
                                    <div class="form-check d-flex justify-content-center">
                                        <input class="form-check-input" type="checkbox" id="defaultCheck10" checked />
                            ...
                            <tr>
                                <td class="text-nowrap">
                                    <h6 class="fw-bold mb-1">Wallet reception</h6>
                                    <small>Be notified when you receved wallet from someone else.</small>
                                </td>
                                <td>
                                    <div class="form-check d-flex justify-content-center">
                                        <input class="form-check-input" type="checkbox" id="defaultCheck10" checked />
