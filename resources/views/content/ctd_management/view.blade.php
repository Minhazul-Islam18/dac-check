                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="" class="text-body text-truncate">
                                                        <span class="fw-semibold">Type of CTD </span></a><small><a
                                                            href="#" class="text-danger">CTD ID</a></small><span
                                        ...
                                        <td>
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#userLots"
                                                ...
                                                <span class="badge bg-white text-primary p-1">4</span>
                                                110000
                                            </button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="" class="text-body text-truncate">
                                                        <span class="fw-semibold">Type of CTD </span></a><small><a
                                                            href="#" class="text-success">CTD ID</a></small><span
                                                        class="d-none">Bangladesh</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#userCartLots"
                                                class="btn btn-label-primary d-flex gap-2 px-2 py-1">
                                                <span class="badge bg-white text-primary p-1">4</span>110000
                                            </button>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
