...
@section('content')
    ...
    <div class="card mb-4">
        <h5 class="card-header">Still Questions?</h5>
        <div class="card-body">
            <div class="">
                <form class="p-3 p-md-5">
                    <div class="d-flex justify-content-center">
                    ...
                    <div class="col-md-12 mb-4">
                        <label for="TagifyCustomListSuggestion" class="form-label">Skype ID</label>
                        <input id="TagifyCustomListSuggestion" name="TagifyCustomListSuggestion"
                            class="form-control classy3" placeholder="select technologies"
                            value="example@skype.com, +226 5660295, +226 9486584">
                    </div>
                    <div class="col-md-12 mb-4">
                        <label for="TagifyCustomListSuggestion" class="form-label">Whatsapp Number</label>
                        <input id="TagifyCustomListSuggestion" name="TagifyCustomListSuggestion" class="form-control classy"
                            placeholder="select technologies" value="example@skype.com, +226 5660295, +226 9486584">
                    </div>
                    <div class="col-md-12 mb-4">
                        <label for="TagifyCustomListSuggestion" class="form-label">Info email ID</label>
                        <input id="TagifyCustomListSuggestion" name="TagifyCustomListSuggestion"
                            class="form-control classy2" placeholder="select technologies"
                            value="example@skype.com, +226 5660295, +226 9486584">
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-success">Update</button>
        ...
        <div class="container">
            ...
            <table id="dataTable" class="table table-striped table-hover dt-responsive">
                ...
                <tbody>
                    <tr>
                        <td>
                            <h6 class="text-truncate mb-1" style="max-width: 150px;">Lorem ipsum dolor sit amet,
                                consectetur
                                adipisicing
                                elit.</h6>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="addBlog" aria-labelledby="addBlogLabel">
        <div class="offcanvas-header border-bottom">
            <h6 id="addBlogLabel" class="offcanvas-title">Add FAQ</h6>
        ...
        <div class="offcanvas-body mx-0 pt-0 flex-grow-0">
            <form class="add-new-pack pt-0" id="">
                ...
                <div class="form-floating my-3">
                    <input type="text" class="form-control" id="floatingTitle" placeholder="Enter Question">
                    <label for="floatingTitle">Question</label>
                </div>
                <div class="my-3">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <input id="TagifyCustomInlineSuggestion" name="TagifyCustomInlineSuggestion"
                        class="form-control classy4" placeholder="Add meta tags" value="css, html, javascript">
                </div>
    ...
    @include('_partials/_modals/faq-preview')
@endsection
