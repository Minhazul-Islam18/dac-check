...
@section('page-script')
    <script src="{{ asset('assets/js/faq-category.js') }}"></script>
@endsection
...
@section('content')
            ...
            <div class="col-12 pb-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li class="breadcrumb-item active">FAQ's Category</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <table id="dataTable" class="table table-striped table-hover dt-responsive">
                ...
                <thead class="bg-primary">
                    <tr>
                        <th scope="col">FAQ's Category</th>
    ...
    <!-- Offcanvas -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="addCategory" aria-labelledby="addCategoryLabel">
        <div class="offcanvas-header border-bottom">
            <h6 id="addCategoryLabel" class="offcanvas-title">Add FAQ Category</h6>
        ...
        <div class="offcanvas-body mx-0 pt-0 flex-grow-0">
            ...
            <div class="col-12 d-flex flex-column align-items-start">
                ...
                <span style="color:#d0540b;">NB: Select the dropdown sign to select an icon</span>
            </div>
