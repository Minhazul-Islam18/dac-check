                        ...
                        <div class="table-responsive">
                            <table class="table table-flush-spacing">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Commission Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Packages Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Invoice Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">CTD Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Public Official Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Users Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Wtithdraw request Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="text-nowrap">Roles & Permissions Management</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" type="checkbox"
